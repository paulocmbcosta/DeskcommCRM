...
export const DICIONARIO: Traducoes = {
  ...
  "Por esta conexão só dá para responder quem já escreveu. Escolha um número de WhatsApp para chamar o cliente.": {
    es: "Por esta conexión solo se puede responder a quien ya escribió. Elige un número de WhatsApp para llamar al cliente.",
  },

  // ─── Conexões › Chat do site (migration 0272) ───
  // "Tiendanube" e não "Nuvemshop" na frase de instalação: é o nome da MESMA
  // plataforma nos países de língua espanhola, e é por ele que o lojista procura.
  "Chat do site": { es: "Chat del sitio" },
  "Chat do site criado. Agora é só colar o código no seu site.": { es: "Chat del sitio creado. Ahora solo falta pegar el código en tu sitio." },
  "Não foi possível carregar o chat do site.": { es: "No se pudo cargar el chat del sitio." },
  "Não foi possível criar o chat do site.": { es: "No se pudo crear el chat del sitio." },
  "Não foi possível salvar o chat do site.": { es: "No se pudo guardar el chat del sitio." },
  "Não foi possível excluir o chat do site.": { es: "No se pudo eliminar el chat del sitio." },
  "Coloque um chat no seu site": { es: "Pon un chat en tu sitio" },
  "Criar outro chat do site": { es: "Crear otro chat del sitio" },
  "Um balão de conversa aparece no canto do seu site. Quem escrever ali cai no Inbox como uma conversa nova — com lead, atendente e agente de IA, igual ao WhatsApp.": { es: "Un globo de conversación aparece en la esquina de tu sitio. Quien escriba ahí llega al Inbox como una conversación nueva — con lead, agente humano y agente de IA, igual que WhatsApp." },
  "Use um chat por site quando quiser cores, textos ou atendimento diferentes em cada um.": { es: "Usa un chat por sitio cuando quieras colores, textos o atención diferentes en cada uno." },
  "Nome do chat (só você vê)": { es: "Nombre del chat (solo tú lo ves)" },
  "Ex.: Site da loja": { es: "Ej.: Sitio de la tienda" },
  "Criar chat do site": { es: "Crear chat del sitio" },
  "Chat do site salvo. O site mostra a mudança na próxima carga de página.": { es: "Chat del sitio guardado. El sitio muestra el cambio en la próxima carga de página." },
  "Chat do site excluído. O balão já saiu do ar.": { es: "Chat del sitio eliminado. El globo ya no está en línea." },
  "Não pedir": { es: "No pedir" },
  "Pedir, sem obrigar": { es: "Pedir, sin obligar" },
  "As mensagens deste chat entram no Inbox como conversas novas.": { es: "Los mensajes de este chat entran al Inbox como conversaciones nuevas." },
  "Título do chat": { es: "Título del chat" },
  "Frase abaixo do título": { es: "Frase debajo del título" },
  "Mensagem de boas-vindas": { es: "Mensaje de bienvenida" },
  "Cor principal": { es: "Color principal" },
  "Escolher a cor principal": { es: "Elegir el color principal" },
  "Use um código de cor como #2563eb.": { es: "Usa un código de color como #2563eb." },
  "Posição na tela": { es: "Posición en la pantalla" },
  "Canto direito": { es: "Esquina derecha" },
  "Canto esquerdo": { es: "Esquina izquierda" },
  "Idioma dos botões": { es: "Idioma de los botones" },
  "Português": { es: "Portugués" },
  "Antes de começar a conversa, pedir:": { es: "Antes de empezar la conversación, pedir:" },
  "Quem fecha a aba do site some. Com telefone ou e-mail, o atendente e o follow-up conseguem continuar a conversa depois.": { es: "Quien cierra la pestaña del sitio desaparece. Con teléfono o correo, el agente y el seguimiento pueden continuar la conversación después." },
  Pedir: { es: "Pedir" },
  "Sites autorizados (opcional)": { es: "Sitios autorizados (opcional)" },
  "Um endereço por linha, sem https://. Em branco, o chat funciona em qualquer site onde o código for colado.": { es: "Una dirección por línea, sin https://. En blanco, el chat funciona en cualquier sitio donde se pegue el código." },
  "Excluir chat": { es: "Eliminar chat" },
  "Agente de IA neste chat": { es: "Agente de IA en este chat" },
  "Todo canal novo nasce com a IA em modo de teste. No chat do site, o modo de teste só reconhece o visitante que informar, no formulário do chat, um telefone da lista de teste. Para a IA responder qualquer visitante, abra-a ao público.": { es: "Todo canal nuevo nace con la IA en modo de prueba. En el chat del sitio, el modo de prueba solo reconoce al visitante que informe, en el formulario del chat, un teléfono de la lista de prueba. Para que la IA responda a cualquier visitante, ábrela al público." },
  "Excluir o chat": { es: "Eliminar el chat" },
  "O balão some do site na hora, mesmo com o código ainda colado lá. As conversas já recebidas continuam no Inbox. Não há desfazer: para voltar a ter chat neste site, será preciso criar outro e colar o código novo.": { es: "El globo desaparece del sitio al instante, aunque el código siga pegado allí. Las conversaciones ya recibidas siguen en el Inbox. No se puede deshacer: para volver a tener chat en este sitio habrá que crear otro y pegar el código nuevo." },
  h: { es: "h" },
  "Ainda não instalado": { es: "Aún no instalado" },
  Instalado: { es: "Instalado" },
  "Instalar no site": { es: "Instalar en el sitio" },
  "Copie o código abaixo e cole em todas as páginas do seu site, logo antes de": { es: "Copia el código de abajo y pégalo en todas las páginas de tu sitio, justo antes de" },
  "Em WordPress, Wix, Nuvemshop e parecidos, procure por “código personalizado” ou “scripts do rodapé”.": { es: "En WordPress, Wix, Tiendanube y similares, busca “código personalizado” o “scripts del pie de página”." },
  "Código copiado.": { es: "Código copiado." },
  "Copiar código": { es: "Copiar código" },
  "Depois de colar, abra o seu site: em até um minuto esta tela passa a mostrar “Instalado” com o endereço onde o chat apareceu.": { es: "Después de pegar, abre tu sitio: en hasta un minuto esta pantalla pasa a mostrar “Instalado” con la dirección donde apareció el chat." },
  "Prévia do chat": { es: "Vista previa del chat" },
  "Prévia": { es: "Vista previa" },
  "Seu WhatsApp ou telefone": { es: "Tu WhatsApp o teléfono" },
  "Iniciar conversa": { es: "Iniciar conversación" },
  "Olá! Queria tirar uma dúvida.": { es: "¡Hola! Quería hacer una consulta." },
  "Escreva sua mensagem…": { es: "Escribe tu mensaje…" },
  "Limite de chats do site atingido. Exclua um para criar outro.": { es: "Límite de chats del sitio alcanzado. Elimina uno para crear otro." },
  "Entrou pelo chat do site": { es: "Entró por el chat del sitio" },
  ...
  "ID do app do webhook (opcional)": { es: "ID de la app del webhook (opcional)" },
  "Preencha quando o token acima foi gerado em um app e o webhook deste número vem de outro. A chave secreta é conferida com este app.": { es: "Complete cuando el token de arriba se generó en una app y el webhook de este número viene de otra. La clave secreta se verifica con esta app." },
  "Informe a chave secreta do app junto com o ID do app.": { es: "Informe la clave secreta de la app junto con el ID de la app." },
  "A chave secreta não é do app deste token. Se o webhook deste número vem de outro app da Meta, informe também o ID desse app.": { es: "La clave secreta no es de la app de este token. Si el webhook de este número viene de otra app de Meta, informe también el ID de esa app." },
  "A Meta não confirmou a chave secreta deste app:": { es: "Meta no confirmó la clave secreta de esta app:" },
  "Adicionar outro número": { es: "Agregar otro número" },
  "app da Meta próprio": { es: "app de Meta propio" },
  "Um número novo vira uma caixa de entrada nova, ao lado das que já existem — nenhuma é substituída.": { es: "Un número nuevo se convierte en una bandeja de entrada nueva, junto a las que ya existen — ninguna se reemplaza." },
  "Chave secreta do app (opcional)": { es: "Clave secreta de la app (opcional)" },
  "•••• (já guardada — preencha para trocar)": { es: "•••• (ya guardada — complete para cambiar)" },
  "Só se este número pertence a um app da Meta diferente do cadastrado na instalação. Sem ela, as mensagens desse número chegam e são recusadas. Fica em Configurações do app › Básico › Chave secreta do app.": { es: "Solo si este número pertenece a una app de Meta distinta de la registrada en la instalación. Sin ella, los mensajes de ese número llegan y son rechazados. Está en Configuración de la app › Básica › Clave secreta de la app." },
  "Espelho de": { es: "Espejo de" },
  "contas": { es: "cuentas" },
  ...
  "Ações da mensagem": { es: "Acciones del mensaje" },
  "Reagir": { es: "Reaccionar" },
  "Escolha uma reação": { es: "Elige una reacción" },
  "Reagir com": { es: "Reaccionar con" },
  "Mais emojis": { es: "Más emojis" },
  "Todos os emojis": { es: "Todos los emojis" },
  "Outro emoji": { es: "Otro emoji" },
  "Cole um emoji ou abra o teclado de emojis do sistema (Windows: Win + . · Mac: Ctrl + Cmd + Espaço).": { es: "Pega un emoji o abre el teclado de emojis del sistema (Windows: Win + . · Mac: Ctrl + Cmd + Espacio)." },
  "Nós": { es: "Nosotros" },
  "Reações": { es: "Reacciones" },
  "Mensagem não encontrada.": { es: "Mensaje no encontrado." },
  "Escolha um emoji.": { es: "Elige un emoji." },
  "Este canal não permite reagir a mensagens.": { es: "Este canal no permite reaccionar a mensajes." },
  ...
  "O e-mail não saiu — copie o link abaixo e mande para a pessoa.": {
    es: "El correo no salió — copia el enlace de abajo y envíalo a la persona.",
  },
  // ─── Cadastro de membro com senha (2026-09-22) ───
  "A pessoa pode trocar esta senha por uma que só ela conhece, em Configurações › Perfil.": { es: "La persona puede cambiar esta contraseña por una que solo ella conozca, en Configuración › Perfil." },
  "A senha antiga deixa de valer para novas entradas. Quem já estiver conectado pode continuar até sair — para tirar a pessoa na hora, use Revogar acesso.": { es: "La contraseña anterior deja de valer para nuevos ingresos. Quien ya esté conectado puede seguir hasta salir — para sacar a la persona en el momento, usa Revocar acceso." },
  "O acompanhamento não cadastra membros com senha. Saia do acompanhamento ou use o convite.": { es: "El acompañamiento no registra miembros con contraseña. Sal del acompañamiento o usa la invitación." },
  "O corpo precisa ser JSON.": { es: "El cuerpo debe ser JSON." },
  "Você abriu esta organização para outra pessoa. O administrador que vai assumi-la entra por convite, escolhendo a própria senha — assim só ele a conhece.": { es: "Abriste esta organización para otra persona. El administrador que la va a asumir entra por invitación, eligiendo su propia contraseña — así solo él la conoce." },
  "Este e-mail foi recusado. Confira se está escrito certo.": { es: "Este correo fue rechazado. Revisa si está bien escrito." },
  "Membro inválido.": { es: "Miembro inválido." },
  "O acompanhamento não troca a senha de ninguém. Saia do acompanhamento para continuar.": { es: "El acompañamiento no cambia la contraseña de nadie. Sal del acompañamiento para continuar." },
  "Esta pessoa também faz parte de outra organização; só ela pode trocar a própria senha, em Configurações › Perfil.": { es: "Esta persona también forma parte de otra organización; solo ella puede cambiar su propia contraseña, en Configuración › Perfil." },
  "A senha nova é igual à atual. Escolha outra.": { es: "La nueva contraseña es igual a la actual. Elige otra." },
  "A senha desta conta foi definida pelo administrador de outra equipe. Antes de entrar nesta, troque-a por uma só sua em Configurações › Perfil › Trocar senha e depois abra este link de novo.": { es: "La contraseña de esta cuenta fue definida por el administrador de otro equipo. Antes de entrar en este, cámbiala por una solo tuya en Configuración › Perfil › Cambiar contraseña y luego abre este enlace de nuevo." },
  "Senha trocada. Use a nova na próxima entrada.": { es: "Contraseña cambiada. Usa la nueva en el próximo ingreso." },
  "Trocar senha": { es: "Cambiar contraseña" },
  "Se quem administra definiu sua senha, troque-a aqui por uma que só você conhece.": { es: "Si quien administra definió tu contraseña, cámbiala aquí por una que solo tú conozcas." },
  "Senha atual": { es: "Contraseña actual" },
  "Senha nova": { es: "Nueva contraseña" },
  "Confirmar senha nova": { es: "Confirmar nueva contraseña" },
  "Trocando…": { es: "Cambiando…" },
  "A senha nova precisa ter de 8 a 72 caracteres.": { es: "La nueva contraseña debe tener de 8 a 72 caracteres." },
  "A confirmação não é igual à senha nova.": { es: "La confirmación no es igual a la nueva contraseña." },
  "Sua sessão terminou. Entre de novo para trocar a senha.": { es: "Tu sesión terminó. Entra de nuevo para cambiar la contraseña." },
  "Muitas tentativas. Espere alguns minutos e tente de novo.": { es: "Demasiados intentos. Espera unos minutos e inténtalo de nuevo." },
  "A senha atual não confere.": { es: "La contraseña actual no coincide." },
  "Entre de novo com o código do aplicativo para trocar a senha.": { es: "Entra de nuevo con el código de la aplicación para cambiar la contraseña." },
  "A senha nova foi recusada pela política de senhas desta instalação. Escolha outra, mais longa e menos óbvia.": { es: "La nueva contraseña fue rechazada por la política de contraseñas de esta instalación. Elige otra, más larga y menos obvia." },
  "Adicionar membros": { es: "Agregar miembros" },
  "Cadastre a pessoa já com uma senha, ou mande um convite para ela criar a própria.": { es: "Registra a la persona ya con una contraseña, o envíale una invitación para que cree la suya." },
  "Cadastrar com senha": { es: "Registrar con contraseña" },
  "Convidar por e-mail": { es: "Invitar por correo" },
  "O envio de e-mail não está configurado nesta instalação: o convite gera um link que você copia e manda para a pessoa. Para entrar sem link, use “Cadastrar com senha”.": { es: "El envío de correo no está configurado en esta instalación: la invitación genera un enlace que copias y envías a la persona. Para entrar sin enlace, usa “Registrar con contraseña”." },
  "A senha precisa de pelo menos 8 caracteres.": { es: "La contraseña necesita al menos 8 caracteres." },
  "entrou na equipe.": { es: "entró al equipo." },
  "Confira os campos: nome, e-mail válido e senha de 8 a 72 caracteres.": { es: "Revisa los campos: nombre, correo válido y contraseña de 8 a 72 caracteres." },
  "Não foi possível cadastrar o membro. Tente novamente.": { es: "No se pudo registrar al miembro. Inténtalo de nuevo." },
  "Dados de acesso copiados.": { es: "Datos de acceso copiados." },
  "Não foi possível copiar. Selecione o texto e copie à mão.": { es: "No se pudo copiar. Selecciona el texto y cópialo a mano." },
  "Papel": { es: "Rol" },
  "Cadastrando…": { es: "Registrando…" },
  "Cadastrar membro": { es: "Registrar miembro" },
  "Dados de acesso": { es: "Datos de acceso" },
  "já pode entrar.": { es: "ya puede entrar." },
  "Passe estes dados para a pessoa. A senha não fica guardada nesta tela: copie agora.": { es: "Pasa estos datos a la persona. La contraseña no queda guardada en esta pantalla: cópiala ahora." },
  "Copiar dados de acesso": { es: "Copiar datos de acceso" },
  "Ver a equipe": { es: "Ver el equipo" },
  "Esqueceu a senha depois? Em Equipe › Membros, use “Definir nova senha” no menu da pessoa.": { es: "¿Olvidó la contraseña después? En Equipo › Miembros, usa “Definir nueva contraseña” en el menú de la persona." },
  "Os dados de acesso aparecem aqui depois do cadastro.": { es: "Los datos de acceso aparecen aquí después del registro." },
  "Senha copiada.": { es: "Contraseña copiada." },
  "Não foi possível copiar. Selecione a senha e copie à mão.": { es: "No se pudo copiar. Selecciona la contraseña y cópiala a mano." },
  "Gerar senha": { es: "Generar contraseña" },
  "Mínimo de 8 caracteres. É você quem vai passar esta senha para a pessoa.": { es: "Mínimo de 8 caracteres. Eres tú quien le pasará esta contraseña a la persona." },
  "Senha nova definida para": { es: "Nueva contraseña definida para" },
  "A senha precisa ter de 8 a 72 caracteres.": { es: "La contraseña debe tener de 8 a 72 caracteres." },
  "Não foi possível trocar a senha. Tente novamente.": { es: "No se pudo cambiar la contraseña. Inténtalo de nuevo." },
  "Salvar senha": { es: "Guardar contraseña" },
  "Esta instalação não tem a chave de serviço do banco configurada; use o convite por link.": { es: "Esta instalación no tiene configurada la clave de servicio de la base de datos; usa la invitación por enlace." },
  "Esta pessoa já faz parte da equipe.": { es: "Esta persona ya forma parte del equipo." },
  "Este e-mail já tem uma conta no sistema, e a senha dela não é trocada por aqui. Se a pessoa já foi da equipe, use “Devolver acesso” na lista de membros; se não, use o convite por link — ela entra com a senha que já tem.": { es: "Este correo ya tiene una cuenta en el sistema, y su contraseña no se cambia desde aquí. Si la persona ya fue del equipo, usa “Devolver acceso” en la lista de miembros; si no, usa la invitación por enlace — entra con la contraseña que ya tiene." },
  "A senha foi recusada pela política de senhas desta instalação. Escolha outra, mais longa e menos óbvia.": { es: "La contraseña fue rechazada por la política de contraseñas de esta instalación. Elige otra, más larga y menos obvia." },
  "Esta instalação não tem a chave de serviço do banco configurada; a senha não pode ser trocada por aqui.": { es: "Esta instalación no tiene configurada la clave de servicio de la base de datos; la contraseña no se puede cambiar desde aquí." },
  "A sua própria senha não se troca por aqui.": { es: "Tu propia contraseña no se cambia desde aquí." },
  "Este membro está sem acesso. Devolva o acesso antes de definir uma senha.": { es: "Este miembro está sin acceso. Devuélvele el acceso antes de definir una contraseña." },
  "A senha de um administrador da plataforma não se troca por aqui.": { es: "La contraseña de un administrador de la plataforma no se cambia desde aquí." },
  "Falhas": { es: "Fallas" },
  ...
  "Verificando o que este canal permite…": { es: "Verificando qué permite este canal…" },
  "Escreva a primeira mensagem…": { es: "Escriba el primer mensaje…" },
  "Este canal só permite falar primeiro com um modelo aprovado. Depois que o cliente responder, a conversa fica livre por 24 horas.": { es: "Este canal solo permite hablar primero con una plantilla aprobada. Cuando el cliente responda, la conversación queda libre por 24 horas." },
  "e volte quando a plataforma aprovar.": { es: "y vuelva cuando la plataforma la apruebe." },
  "Escolha um modelo…": { es: "Elija una plantilla…" },
  "a preencher": { es: "por completar" },
  "O cliente vai receber": { es: "El cliente va a recibir" },
  "Enviar e abrir conversa": { es: "Enviar y abrir conversación" },
  "Mensagem enviada.": { es: "Mensaje enviado." },
  ...
  "Mídia": { es: "Multimedia" },
  // Aviso de mensagem (lib/notifications/aviso-de-mensagem.ts)
  "📷 Imagem": { es: "📷 Imagen" },
  "🎬 Vídeo": { es: "🎬 Video" },
  "🎤 Áudio": { es: "🎤 Audio" },
  "📄 Documento": { es: "📄 Documento" },
  "📍 Localização": { es: "📍 Ubicación" },
  "👤 Contato compartilhado": { es: "👤 Contacto compartido" },
  "Reagiu a uma mensagem": { es: "Reaccionó a un mensaje" },
  "com você": { es: "contigo" },
  "no automático": { es: "en automático" },
  "aguardando atendente": { es: "esperando agente" },
  ...
  // ─── Inbox: trilho de abas, protocolo, histórico e linha do tempo (0266) ───
  "Visões do inbox": { es: "Vistas de la bandeja" },
  "Filtros": { es: "Filtros" },
  "Ainda não há o que filtrar: os filtros aparecem quando existir mais de um número, um time ou uma etiqueta.": { es: "Todavía no hay nada que filtrar: los filtros aparecen cuando exista más de un número, un equipo o una etiqueta." },
  ...
  "telefone": { es: "teléfono" },
  "e-mail": { es: "correo" },
  "Ver detalhes do contato": { es: "Ver detalles del contacto" },
  "Protocolo": { es: "Protocolo" },
  "Criada em": { es: "Creada el" },
  "Encerrada em": { es: "Cerrada el" },
  "Última mensagem": { es: "Último mensaje" },
  "Atendimentos anteriores": { es: "Atenciones anteriores" },
  "Não consegui ler o histórico de atendimentos.": { es: "No pude leer el historial de atenciones." },
  "Você está vendo este atendimento": { es: "Estás viendo esta atención" },
  "Atendido por": { es: "Atendido por" },
  "Nenhum atendimento registrado para este contato.": { es: "Ninguna atención registrada para este contacto." },
  "Não consegui ler a linha do tempo.": { es: "No pude leer la línea de tiempo." },
  "Nada registrado neste atendimento ainda.": { es: "Todavía no hay nada registrado en esta atención." },
  "As atividades do negócio não puderam ser lidas agora; a linha acima mostra só o que aconteceu na conversa.": { es: "Las actividades del negocio no se pudieron leer ahora; la línea de arriba muestra solo lo que pasó en la conversación." },
  "Atendimentos com este protocolo": { es: "Atenciones con este protocolo" },
  "Erro ao carregar os atendimentos encerrados.": { es: "Error al cargar las atenciones cerradas." },
  "Nenhum atendimento encerrado ainda.": { es: "Todavía no hay ninguna atención cerrada." },
  "O cliente voltou — há outro atendimento em andamento": { es: "El cliente volvió — hay otra atención en curso" },
  "Não foi possível ler os atendimentos encerrados.": { es: "No se pudieron leer las atenciones cerradas." },
  "Você está vendo o atendimento": { es: "Estás viendo la atención" },
  "encerrado em": { es: "cerrada el" },
  "Voltar ao atendimento atual": { es: "Volver a la atención actual" },
  "Este atendimento já foi encerrado. Volte ao atendimento atual para responder.": { es: "Esta atención ya fue cerrada. Vuelve a la atención actual para responder." },
  "Nenhuma mensagem neste atendimento.": { es: "Ningún mensaje en esta atención." },
  "Ações do contato": { es: "Acciones del contacto" },
  "Novo atendimento aberto": { es: "Nueva atención abierta" },
  "Conversa aberta": { es: "Conversación abierta" },
  "O cliente voltou a escrever.": { es: "El cliente volvió a escribir." },
  "Encerrada automaticamente.": { es: "Cerrada automáticamente." },
  "Conversa reaberta": { es: "Conversación reabierta" },
  "O protocolo continua o mesmo.": { es: "El protocolo sigue siendo el mismo." },
  "Devolvida à fila geral": { es: "Devuelta a la cola general" },
  "Saiu do time": { es: "Salió del equipo" },
  "Transferida para a fila do time": { es: "Transferida a la cola del equipo" },
  "Por": { es: "Por" },
  "Aguardando operador disponível.": { es: "Esperando un operador disponible." },
  "Distribuída automaticamente": { es: "Distribuida automáticamente" },
  "recebeu a conversa pelo rodízio.": { es: "recibió la conversación por la rotación." },
  "Atendimento assumido": { es: "Atención asumida" },
  "assumiu a conversa.": { es: "asumió la conversación." },
  "Conversa transferida": { es: "Conversación transferida" },
  "Para": { es: "Para" },
  "Conversa liberada": { es: "Conversación liberada" },
  "devolveu a conversa à fila.": { es: "devolvió la conversación a la cola." },
  "Voltou para a fila.": { es: "Volvió a la cola." },
  "Passada para atendimento humano": { es: "Pasada a atención humana" },
  "O atendimento automático chamou uma pessoa.": { es: "La atención automática llamó a una persona." },
  "Atendimento automático pausado": { es: "Atención automática pausada" },
  "Devolvida ao atendimento automático": { es: "Devuelta a la atención automática" },
  "Lembrete agendado": { es: "Recordatorio programado" },
  "menos de 1 min": { es: "menos de 1 min" },
  "Conversa encerrada": { es: "Conversación cerrada" },
  "Conversa resolvida": { es: "Conversación resuelta" },
  "Conversa arquivada": { es: "Conversación archivada" },
  // ─── Status do atendente, pausa e limite por time (0267) ───
  "Seu status de atendimento": { es: "Tu estado de atención" },
  "Em pausa": { es: "En pausa" },
  "Você recebe conversas novas do rodízio.": { es: "Recibes conversaciones nuevas de la rotación." },
  "Em pausa você não recebe conversas novas. As que já são suas continuam com você.": { es: "En pausa no recibes conversaciones nuevas. Las que ya son tuyas siguen contigo." },
  "Offline você não recebe conversas novas do rodízio.": { es: "Sin conexión no recibes conversaciones nuevas de la rotación." },
  "Não consegui ler o seu status.": { es: "No pude leer tu estado." },
  "Conversas com você agora": { es: "Conversaciones contigo ahora" },
  "Voltar da pausa": { es: "Volver de la pausa" },
  "Ficar online": { es: "Ponerme en línea" },
  "Trocar o motivo da pausa…": { es: "Cambiar el motivo de la pausa…" },
  "Entrar em pausa…": { es: "Entrar en pausa…" },
  "Ficar offline": { es: "Ponerme sin conexión" },
  "Entrar em pausa": { es: "Entrar en pausa" },
  "Enquanto você estiver em pausa, as conversas novas do seu time vão para outro colega ou esperam na fila. Escolha o motivo — ele fica registrado.": { es: "Mientras estés en pausa, las conversaciones nuevas de tu equipo van a otro compañero o esperan en la cola. Elige el motivo — queda registrado." },
  "Motivo da pausa": { es: "Motivo de la pausa" },
  "Qual o motivo?": { es: "¿Cuál es el motivo?" },
  "Observação (opcional)": { es: "Observación (opcional)" },
  "Ex.: volto às 13h": { es: "Ej.: vuelvo a las 13 h" },
  "Limite de conversas simultâneas por atendente": { es: "Límite de conversaciones simultáneas por agente" },
  "Sem limite": { es: "Sin límite" },
  "Use um número inteiro a partir de 1, ou deixe em branco para não limitar.": { es: "Usa un número entero a partir de 1, o deja en blanco para no limitar." },
  "Com todos no limite, a conversa nova espera na fila do time até alguém ter vaga — não vai para quem já está cheio.": { es: "Con todos en el límite, la conversación nueva espera en la cola del equipo hasta que alguien tenga lugar — no va a quien ya está lleno." },
  "Online": { es: "En línea" },
  "Offline": { es: "Sin conexión" },
  "Banheiro": { es: "Baño" },
  "Almoço": { es: "Almuerzo" },
  "Intervalo": { es: "Descanso" },
  ...
  "boleto ainda não gerado": { es: "boleto aún no generado" },
  "O IXC vai gerar o Pix desta fatura agora.": { es: "IXC va a generar el Pix de esta factura ahora." },
  "O IXC respondeu:": { es: "IXC respondió:" },
  "O IXC ainda não registrou o boleto desta fatura. Envie por Pix ou gere o boleto por lá.": { es: "IXC todavía no registró el boleto de esta factura. Envíalo por Pix o genera el boleto allí." },
  "A cobrança saiu incompleta: confira a conversa e envie de novo.": { es: "El cobro salió incompleto: revisa la conversación y envíalo de nuevo." },
  "Boleto": { es: "Boleto" },
  "Boleto enviado na conversa.": { es: "Boleto enviado en la conversación." },
  "Como enviar esta fatura": { es: "Cómo enviar esta factura" },
  "Enviar como": { es: "Enviar como" },
  "Não consegui enviar a cobrança.": { es: "No pude enviar el cobro." },
  "O IXC ainda não gerou o boleto desta fatura.": { es: "IXC todavía no generó el boleto de esta factura." },
  "Pix": { es: "Pix" },
  "Pix enviado na conversa.": { es: "Pix enviado en la conversación." },
  "O IXC não devolveu a cobrança desta fatura. Tente de novo; se insistir, gere por lá.": { es: "IXC no devolvió el cobro de esta factura. Inténtalo de nuevo; si insiste, genéralo allí." },
  "O Pix desta fatura não está mais ativo no IXC. Envie o boleto ou gere um Pix novo por lá.": { es: "El Pix de esta factura ya no está activo en IXC. Envía el boleto o genera un Pix nuevo allí." },
  "O código Pix que o IXC devolveu não passou na conferência, e por isso não foi enviado.": { es: "El código Pix que devolvió IXC no pasó la verificación, y por eso no se envió." },
  "bloqueio manual": { es: "bloqueo manual" },
  "bloqueio automático": { es: "bloqueo automático" },
  "financeiro em atraso": { es: "pagos atrasados" },
  "Conectores": { es: "Conectores" },
  "Ligue o sistema que a sua empresa já usa para operar. Os dados do cliente passam a aparecer no atendimento, ao lado da conversa, sem ninguém precisar trocar de tela.": { es: "Conecta el sistema que tu empresa ya usa para operar. Los datos del cliente aparecen en la atención, junto a la conversación, sin que nadie tenga que cambiar de pantalla." },
  "Conexão testada e salva.": { es: "Conexión probada y guardada." },
  "Não consegui salvar a conexão.": { es: "No pude guardar la conexión." },
  "Não consegui testar a conexão.": { es: "No pude probar la conexión." },
  "Conector desligado.": { es: "Conector desactivado." },
  "Não consegui desligar o conector.": { es: "No pude desactivar el conector." },
  "Ligado": { es: "Activado" },
  "Com problema": { es: "Con problema" },
  "Desligado": { es: "Desactivado" },
  "Enquanto isso, o painel do atendimento não mostra os dados.": { es: "Mientras tanto, el panel de atención no muestra los datos." },
  "Token": { es: "Token" },
  "Último teste": { es: "Última prueba" },
  "Endereço do sistema": { es: "Dirección del sistema" },
  "Deixe em branco para manter o token atual": { es: "Déjalo en blanco para mantener el token actual" },
  "Testar e salvar": { es: "Probar y guardar" },
  "O token é testado antes de ser salvo, fica cifrado e nunca volta a aparecer nesta tela.": { es: "El token se prueba antes de guardarse, queda cifrado y nunca vuelve a aparecer en esta pantalla." },
  ...
  "A IA não envia a cobrança dessas faturas: avisa o cliente que ela foi encaminhada ao setor de cobrança e transfere a conversa.": {
    es: "La IA no envía el cobro de esas facturas: avisa al cliente que fue derivada al sector de cobranzas y transfiere la conversación.",
  },
  ...
  "Não consegui ler os conectores.": { es: "No pude leer los conectores." },
  "Este conector não tem painel nesta versão.": { es: "Este conector no tiene panel en esta versión." },
  "A última consulta a este sistema falhou.": { es: "La última consulta a este sistema falló." },
  "O token do IXC não tem acesso a esta informação.": { es: "El token de IXC no tiene acceso a esta información." },
  "Não consegui ler esta parte no IXC agora.": { es: "No pude leer esta parte en IXC ahora." },
  "vencida há 1 dia": { es: "vencida hace 1 día" },
  "vencida há": { es: "vencida hace" },
  "a vencer": { es: "por vencer" },
  "Contrato": { es: "Contrato" },
  "Acesso": { es: "Acceso" },
  "Parcelas em atraso": { es: "Cuotas atrasadas" },
  "Desbloqueio de confiança": { es: "Desbloqueo de confianza" },
  "Ativo agora": { es: "Activo ahora" },
  "Ativado em": { es: "Activado el" },
  "Instalação": { es: "Instalación" },
  "Nº do contrato": { es: "N.º de contrato" },
  "Conectou em": { es: "Se conectó el" },
  "Última queda": { es: "Última caída" },
  "Motivo da queda": { es: "Motivo de la caída" },
  "Sinal da ONU": { es: "Señal de la ONU" },
  "Recebido (RX)": { es: "Recibido (RX)" },
  "Enviado (TX)": { es: "Enviado (TX)" },
  "Causa da última queda": { es: "Causa de la última caída" },
  "Leitura de": { es: "Lectura del" },
  "Não consegui vincular.": { es: "No pude vincular." },
  "Atualizar dados do IXC": { es: "Actualizar datos de IXC" },
  "Consultando o IXC…": { es: "Consultando IXC…" },
  ...
  "Este contato não tem um telefone que eu possa procurar no IXC.": { es: "Este contacto no tiene un teléfono que pueda buscar en IXC." },
  "Não consegui desfazer o vínculo.": { es: "No pude deshacer el vínculo." },
  "Não é este cliente? Desfazer vínculo": { es: "¿No es este cliente? Deshacer vínculo" },
  "Este contato está ligado a um cadastro que o IXC não devolve mais.": { es: "Este contacto está vinculado a un registro que IXC ya no devuelve." },
  "Copiar documento": { es: "Copiar documento" },
  "Cadastro no IXC": { es: "Registro en IXC" },
  "Nenhum contrato neste cadastro.": { es: "Ningún contrato en este registro." },
  "Financeiro": { es: "Finanzas" },
  "Nenhuma fatura vencida.": { es: "Ninguna factura vencida." },
  "em 1 fatura vencida": { es: "en 1 factura vencida" },
  "faturas vencidas": { es: "facturas vencidas" },
  "Próximas a vencer": { es: "Próximas a vencer" },
  "Mais 1 parcela futura no IXC.": { es: "1 cuota futura más en IXC." },
  "Mais": { es: "Más" },
  "parcelas futuras no IXC.": { es: "cuotas futuras en IXC." },
  "Nenhum login de conexão neste cadastro.": { es: "Ningún login de conexión en este registro." },
  "Ordens de serviço abertas": { es: "Órdenes de servicio abiertas" },
  "Nenhuma ordem de serviço aberta.": { es: "Ninguna orden de servicio abierta." },
  "Aberta em": { es: "Abierta el" },
  "Atendimentos abertos no IXC": { es: "Atenciones abiertas en IXC" },
  "Nenhum atendimento aberto.": { es: "Ninguna atención abierta." },
  "Buscar pelo CPF ou CNPJ do cliente": { es: "Buscar por el CPF o CNPJ del cliente" },
  "Pré-contrato": { es: "Precontrato" },
  "Negativado": { es: "Reportado por deuda" },
  "Desistiu": { es: "Desistió" },
  "Liberado": { es: "Habilitado" },
  "Aguardando assinatura": { es: "Esperando firma" },
  "Encaminhada": { es: "Derivada" },
  "Assumida": { es: "Asumida" },
  "Aguardando reagendamento": { es: "Esperando reagendamiento" },
  "Em execução": { es: "En ejecución" },
  "Finalizada": { es: "Finalizada" },
  "Em progresso": { es: "En progreso" },
  "Solucionado": { es: "Solucionado" },
  "Normal": { es: "Normal" },
  "Crítica": { es: "Crítica" },
  "Sem informação": { es: "Sin información" },
  "Login desativado": { es: "Login desactivado" },
  "Sem leitura": { es: "Sin lectura" },
  "Bom": { es: "Bueno" },
  "No limite": { es: "En el límite" },
  "Ruim": { es: "Malo" },
  "Sem contrato ativo": { es: "Sin contrato activo" },
  "O endereço não é aceito. Use o endereço público do sistema, começando com https://.": { es: "La dirección no es aceptada. Usa la dirección pública del sistema, empezando con https://." },
  "O sistema não respondeu. Confira o endereço e se ele está no ar.": { es: "El sistema no respondió. Revisa la dirección y si está en línea." },
  "O sistema recusou o token. Confira se ele está certo e ativo.": { es: "El sistema rechazó el token. Revisa que sea correcto y esté activo." },
  "O token não tem acesso a um dos dados que o painel usa.": { es: "El token no tiene acceso a uno de los datos que usa el panel." },
  "O sistema respondeu de um jeito que não entendi.": { es: "El sistema respondió de una forma que no entendí." },
  "Sistema de gestão de provedor de internet. Mostra no atendimento o contrato, o bloqueio, as faturas, as ordens de serviço e a conexão do cliente.": { es: "Sistema de gestión de proveedor de internet. Muestra en la atención el contrato, el bloqueo, las facturas, las órdenes de servicio y la conexión del cliente." },
  "O endereço que você usa para abrir o IXC. Ex.: https://suaempresa.ixcsoft.com.br": { es: "La dirección que usas para abrir IXC. Ej.: https://tuempresa.ixcsoft.com.br" },
  "Gerado no IXC, no cadastro de usuário com acesso à API. Peça um token SÓ DE LEITURA, dedicado a esta integração.": { es: "Generado en IXC, en el registro de usuario con acceso a la API. Pide un token SOLO DE LECTURA, dedicado a esta integración." },
  "Conector desconhecido.": { es: "Conector desconocido." },
  "Informe o token.": { es: "Informa el token." },
  "Este conector já está desligado.": { es: "Este conector ya está desactivado." },
  "Este conector não está ligado.": { es: "Este conector no está activado." },
  "Conexão funcionando.": { es: "Conexión funcionando." },
  "O IXC não está ligado nesta organização.": { es: "IXC no está activado en esta organización." },
  "CPF ou CNPJ inválido. Confira os números.": { es: "CPF o CNPJ inválido. Revisa los números." },
  "Não há cadastro no IXC com este documento.": { es: "No hay registro en IXC con este documento." },
  "Este cadastro não corresponde ao telefone do contato.": { es: "Este registro no corresponde al teléfono del contacto." },
  "Este vínculo não existe.": { es: "Este vínculo no existe." },
  "Fatura não encontrada.": { es: "Factura no encontrada." },
  "Esta fatura não está mais em aberto. Atualize o painel.": { es: "Esta factura ya no está pendiente. Actualiza el panel." },
  // Inbox: chips por time, fila do time e termômetro de espera (migration 0279).
  "Há atendente livre: a conversa deve ser entregue em instantes.": { es: "Hay un agente libre: la conversación se asignará en instantes." },
  "O time está fora do horário de atendimento.": { es: "El equipo está fuera del horario de atención." },
  "O time não tem nenhum atendente cadastrado.": { es: "El equipo no tiene ningún agente registrado." },
  "Nenhum atendente do time está disponível agora.": { es: "Ningún agente del equipo está disponible ahora." },
  "Todos os atendentes disponíveis estão no limite de conversas.": { es: "Todos los agentes disponibles están en el límite de conversaciones." },
  "Transferidas para um time e ainda sem atendente": { es: "Transferidas a un equipo y aún sin agente" },
  "Só na fila": { es: "Solo en cola" },
  "Quem está há mais tempo sem resposta aparece primeiro": { es: "Quien lleva más tiempo sin respuesta aparece primero" },
  "Mais tempo esperando": { es: "Más tiempo esperando" },
  "Cliente sem resposta desde": { es: "Cliente sin respuesta desde" },
  "Transferida para o time e ainda sem atendente": { es: "Transferida al equipo y aún sin agente" },
  "Na fila": { es: "En cola" },
  "Use minutos inteiros, de 1 a 1440, crescendo do amarelo ao vermelho.": { es: "Use minutos enteros, de 1 a 1440, crecientes del amarillo al rojo." },
  "Só gestor ou administrador pode mudar essa regra.": { es: "Solo un gestor o administrador puede cambiar esta regla." },
  "Amarelo a partir de": { es: "Amarillo a partir de" },
  "Laranja a partir de": { es: "Naranja a partir de" },
  "Vermelho pulsando a partir de": { es: "Rojo parpadeando a partir de" },
  "Régua salva.": { es: "Escala guardada." },
  "Termômetro de espera": { es: "Termómetro de espera" },
  "Quanto tempo o cliente pode ficar sem resposta de uma pessoa antes de o card mudar de cor no Inbox. Conta a partir da primeira mensagem dele que ninguém respondeu.": { es: "Cuánto tiempo puede quedar el cliente sin respuesta de una persona antes de que la tarjeta cambie de color en el Inbox. Cuenta desde su primer mensaje que nadie respondió." },
  "Salvar régua": { es: "Guardar escala" },
  "Voltar ao padrão (2 / 5 / 10)": { es: "Volver al estándar (2 / 5 / 10)" },
  "Não foi possível ler a fila dos times.": { es: "No fue posible leer la cola de los equipos." },
  // Sentimento do cliente visível para a equipe (migration 0280).
  "Satisfeito": { es: "Satisfecho" },
  "Neutro": { es: "Neutro" },
