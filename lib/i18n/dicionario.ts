...
export const DICIONARIO: Traducoes = {
  ...
  "Você criou esta organização para outra pessoa e acabou de cadastrar um administrador: a organização foi entregue a essa pessoa, e você saiu dela.": { es: "Creaste esta organización para otra persona y acabas de registrar a un administrador: la organización fue entregada a esa persona, y saliste de ella." },
  ...
  "A senha antiga deixa de valer. Passe a nova para a pessoa; ela entra com o mesmo e-mail.": { es: "La contraseña anterior deja de valer. Pasa la nueva a la persona; entra con el mismo correo." },
  ...
  "Esta pessoa também faz parte de outra organização; só ela pode trocar a própria senha.": { es: "Esta persona también forma parte de otra organización; solo ella puede cambiar su propia contraseña." },
