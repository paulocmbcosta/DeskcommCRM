...
export const DICIONARIO: Traducoes = {
  ...
  "Fatura enviada na conversa.": { es: "Factura enviada en la conversación." },
  "Não consegui enviar a fatura.": { es: "No pude enviar la factura." },
  ...
  "O boleto desta fatura ainda não foi gerado no IXC. Gere por lá ou fale com o financeiro.": { es: "El boleto de esta factura aún no fue generado en IXC. Genéralo allí o habla con finanzas." },
};
