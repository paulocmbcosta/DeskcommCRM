...
export const DICIONARIO: Traducoes = {
  ...
  "Bloqueado — bloqueio manual": { es: "Bloqueado — bloqueo manual" },
  "Bloqueado — bloqueio automático": { es: "Bloqueado — bloqueo automático" },
  "Bloqueado — financeiro em atraso": { es: "Bloqueado — pagos atrasados" },
