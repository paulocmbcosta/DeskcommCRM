...
export const DICIONARIO: Traducoes = {
  ...
  "O IXC ainda não gerou o Pix desta fatura.": { es: "IXC todavía no generó el Pix de esta factura." },
  ...
  "cobrança ainda não gerada": { es: "cobro aún no generado" },
  "O IXC ainda não gerou esta forma de pagamento para a fatura. Escolha a outra ou gere por lá.": { es: "IXC todavía no generó esta forma de pago para la factura. Elige la otra o genérala allí." },
