...
printf 'Paulo Cesar <paulocmbcosta@gmail.com> <112350008+paulocmbcosta@users.noreply.github.com>\n' > "$principal/.mailmap"
...
git -C "$clone" config user.email "paulocmbcosta@gmail.com"
...
git -C "$clone" config user.email "112350008+paulocmbcosta@users.noreply.github.com"
saida="$(cd "$clone" && bash .agents/skills/deskcomm-contribuir/scripts/quem-sou.sh)"
