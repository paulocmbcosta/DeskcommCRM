...
```bash
curl -fsSL https://raw.githubusercontent.com/paulocmbcosta/DeskcommCRM/main/hostgator-setup-kit/diagnostico.sh | bash
```
...
source:   [https://github.com/paulocmbcosta/DeskcommCRM] ← veio do LABEL do Dockerfile
